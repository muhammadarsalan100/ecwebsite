  ...
  return (
    <section className='w-full px-4 py-12 md:px-8 lg:px-12'>
      <div className='mx-auto max-w-7xl'>
        ...
        >
          <motion.button
            className='text-white font-medium hover:opacity-90 transition-opacity bg-primary shadow-[0_18px_31px_0_rgba(0,146,255,0.15)] w-[186px] h-[50px] rounded-[9px] font-poppins text-[14px]'
