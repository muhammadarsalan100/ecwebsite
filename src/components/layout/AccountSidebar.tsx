...
export function AccountSidebar() {
    ...
    return (
        <aside className="w-full md:w-[280px] md:min-w-[280px] bg-[#0092FF] text-white rounded-2xl flex-shrink-0 h-auto md:h-[650px] flex flex-col justify-between py-6 md:py-8 px-4 shadow-lg">
            <div>
                {/* Profile Section */}
                <div className="flex flex-row md:flex-col items-center gap-4 mb-6 md:mb-5 md:text-center">
                    ...
                    <div>
                        <h3 className="font-bold text-lg md:text-xl text-white">Petter Harry</h3>
            ...
            <div className="pt-4 md:pt-6 mt-4 md:mt-6 border-t border-white/20 hidden md:block">
                <button className="flex items-center gap-4 px-4 py-3 text-sm font-medium text-white/90 hover:text-white hover:bg-white/10 w-full rounded-lg transition-colors">
